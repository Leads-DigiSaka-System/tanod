    ...
    <template v-if="activeTab === 'tps'">
      ...
      <div class="space-y-4">
        ...
        <div v-if="!tpsAssignments?.length" class="bg-white rounded-xl border border-gray-200 shadow-sm dark:bg-gray-800 dark:border-gray-700 px-6 py-12 text-center">
          ...
          <h3 class="mt-2 text-sm font-semibold text-gray-900 dark:text-white">No TPS assignments</h3>
          <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">Assign TPS users to groups to see their tractors here.</p>
        </div>
      </div>
    </template>
