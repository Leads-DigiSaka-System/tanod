  ...
  <AppLayout>
    ...
    <form @submit.prevent="submit" class="bg-white rounded-lg border border-gray-200 shadow-sm p-6 max-w-2xl dark:bg-gray-800 dark:border-gray-700">
      <div class="grid grid-cols-1 gap-6 sm:grid-cols-2">
        ...
        <div v-if="form.role === 'tps'" class="md:col-span-2 rounded-xl border border-emerald-200 bg-emerald-50/70 p-4 dark:border-emerald-800 dark:bg-emerald-900/20">
          <label class="flex items-start gap-3">
            ...
            <div>
              ...
              <p class="mt-1 text-xs text-gray-500 dark:text-gray-400">When enabled, this TPS user can see the full tractor fleet in the mobile app. Leave it off to manage their tractor visibility through Group assignments.</p>
            </div>
          </label>
...
const form = useForm({
  ...
  phone: '', gender: '', role: '', tps_assign_all_tractors: false, profile_photo: null,
});
